...
%       SH              An initialize AgentTaskShare Object
    ...
    %the string literals of all varriables which could possibly be
    ...
    %would have a value of [n,m] or [m,n]. For elements of type String or
    %Other, this value should be set to -1;

%       INPUT
%       SH:         A reference to the initialized Agent or Task Object

%       OUTPUT
%       sizeStruct  A structure defining the type and dimensionality of
%                   all publically accessible recordable class attributes
        sizeStruct = genSizeStruct(SH);
    end
